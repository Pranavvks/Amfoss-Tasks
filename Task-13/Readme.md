**This task was quite challenging.** __The user will be warned if they go beyond the given range of distance that is [0,100]. I have used here two mechainsms inorder to warn the user.
